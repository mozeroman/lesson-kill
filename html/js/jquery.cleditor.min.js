...
(function(e) {
        ...
        if (! (b.disabled || e(c).attr(n) == n)) {
            ...
            if (d == "source") {
                ...
                if (f == "url") {
                    ...
                    j.children(":button").unbind(q).bind(q,
                    function() {
                        var k = j.find(":text"),
                        o = e.trim(k.val());
                ...
                } else f == "pastetext" && j.children(":button").unbind(q).bind(q,
                function() {
                ...
                return
            } else if (d == "print") b.$frame[0].contentWindow.print();
    ...
    function R(a, b, c, d, h) {
        ...
        if (d) f.html(d);
            ...
            c = da
        } else if (a == "font") e.each(b.fonts.split(","),
        function(i, g) {
            e(m).appendTo(f).css("fontFamily", g).html(g)
        });
        else if (a == "size") e.each(b.sizes.split(","),
        function(i, g) {
            e(m).appendTo(f).html("<font size=" + g + ">" + g + "</font>")
        });
        else if (a == "style") e.each(b.styles,
        function(i, g) {
    ...
    function K(a) {
        ...
        if (l) {
            ...
            function(g) {
                ...
                else if (g.type == "beforeactivate") { ! a.inactive && a.range && a.range.length > 1 && a.range.shift();
                    delete a.inactive
                } else if (!a.inactive) {
                    if (!a.range) a.range = [];
    ...
    function u(a) {
        ...
        function(d, h) {
            ...
            } else if ((c || L) && i.name != "source" || l && (g == "undo" || g == "redo")) j = false;
            else if (g && g != "print") {
    ...
    function E(a, b) {
        ...
        if (d.updateTextArea) a.frameChecksum = C(c);
        if (c != f.html()) {
            f.html(c);
    ...
    cleditor = function(a, b) {
        var c = this;
        c.options = b = e.extend({},
        e.cleditor.defaultOptions, b);
        ...
        function(g, j) {
            ...
            if (j == "|") {
                ...
                if (k.stripIndex) G.backgroundPosition = k.stripIndex * -24;
                o.css(G);
                l && o.attr(I, "on");
    ...
    function(a) {
        a.$area.val("");
        E(a)
    }], ["disable", T], ["execCommand", v], ["focus", w], ["hidePopups", r], ["sourceMode", t, true], ["refresh", K], ["select",
    function(a) {
        setTimeout(function() {
    ...
    true], ["selectedText", M, true], ["showMessage", z], ["updateFrame", E], ["updateTextArea", V]],
    function(a, b) {
        $[b[0]] = function() {
