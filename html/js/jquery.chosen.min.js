...
function() {
    ...
    AbstractChosen = function() {
        ...
        AbstractChosen.prototype.results_option_build = function(a) {
            ...
            c.group && c.search_match ? b += this.result_add_group(c) : !c.empty && c.search_match && (b += this.result_add_option(c)),
        ...
        AbstractChosen.prototype.result_add_option = function(a) {
            var b, c;
            return a.dom_id = this.container_id + "_o_" + a.array_index,
            b = [],
            ...
            '<li id="' + a.dom_id + '" class="' + b.join(" ") + '"' + c + ">" + a.search_text + "</li>"
        },
        ...
        AbstractChosen.prototype.winnow_results = function() {
            ...
            for (this.no_results_clear(), f = 0, g = this.get_search_text(), e = this.search_contains ? "": "^", d = new RegExp(e + g.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), j = new RegExp(g.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), o = this.results_data, k = 0, m = o.length; m > k; k++) if (a = o[k], !a.empty) if (a.group) a.search_match = !1;
            else {
                if (a.search_match = !1, d.test(a.html)) a.search_match = !0,
                f += 1;
                else if (this.enable_split_word_search && (a.html.indexOf(" ") >= 0 || 0 === a.html.indexOf("[")) && (c = a.html.replace(/\[|\]/g, "").split(" "), c.length)) for (l = 0, n = c.length; n > l; l++) b = c[l],
                d.test(b) && (a.search_match = !0, f += 1);
        ...
        AbstractChosen.prototype.generate_random_char = function() {
            var a, b, c;
            return a = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ",
...
function() {
    ...
    Chosen = function(d) {
        ...
        Chosen.prototype.result_add_group = function(b) {
            return b.dom_id = this.container_id + "_g_" + b.array_index,
        ...
        Chosen.prototype.result_deselect = function(b) {
            ...
            this.form_field.options[d.options_index].disabled ? !1 : (d.selected = !1, this.form_field.options[d.options_index].selected = !1, this.selected_option_count = null, c = a("#" + this.container_id + "_o_" + b), c.removeClass("result-selected").addClass("active-result").show(), this.result_clear_highlight(), this.results_showing && this.winnow_results(), this.form_field_jq.trigger("change", {
        ...
        Chosen.prototype.search_field_scale = function() {
            var b, c, d, e, f, g, h, i;
            if (this.is_multiple) {
                for (c = 0, g = 0, e = "position:absolute; left: -1000px; top: -1000px; display:none;", f = ["font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing"], h = 0, i = f.length; i > h; h++) d = f[h],
                e += d + ":" + this.search_field.css(d) + ";";
                return b = a("<div />", {
                    style: e
                }),
                ...
                g = b.width() + 25,
                b.remove(),
                this.f_width || (this.f_width = this.container.outerWidth()),
                g > this.f_width - 10 && (g = this.f_width - 10),
