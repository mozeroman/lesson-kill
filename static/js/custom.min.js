...
function messageLike() {
    if ($(".messagesList")) {
        $(".messagesList").on("click", ".star",
        function() {
            $(this).removeClass("star");
            $(this).addClass("dislikes")
        });
        $(".messagesList").on("click", ".dislikes",
        function() {
...
function template_functions() {
    ...
    $("#toggle-fullscreen").button().click(function() {
        ...
        if (!c.hasClass("active")) {
            ...
            $("#thumbnails").removeClass("modal-fullscreen"); (document.webkitCancelFullScreen || document.mozCancelFullScreen || $.noop).apply(document)
        }
    });
    $(".datatable").dataTable({
...
function calendars() {
    ...
    $(".calendar-small").fullCalendar({
        ...
        dayClick: function(g, j, f, d) {
            ...
            var l = $(".calendar-small").fullCalendar("clientEvents",
            function(n) {
                function o(r) {
                    return r < 10 ? "0" + r: r
                }
        ...
        fnUpdate: function(c, k) {
            ...
            for (g = 0, iLen = h.length; g < iLen; g++) {
                ...
                for (f = a; f <= m; f++) {
                    ...
                    $("<li " + d + '><a href="#">' + f + "</a></li>").insertBefore($("li:last", h[g])[0]).bind("click",
                    function(i) {
                        i.preventDefault();
